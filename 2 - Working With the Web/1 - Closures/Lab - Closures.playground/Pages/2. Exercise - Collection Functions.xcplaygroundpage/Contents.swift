...
var friends = ["Cris", "gabe", "Marco", "Chance", "Calvin"]
let sortedCollection1 = friends.sorted(by: forwards(name1:name2:))
...
let collection2 = friends.sorted { (friend1, friend2)-> Bool in
...
let collection3 = friends.sorted(by: <)
print(collection3)
