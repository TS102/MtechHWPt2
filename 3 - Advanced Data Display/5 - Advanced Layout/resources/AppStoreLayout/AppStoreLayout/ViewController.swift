...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // creating the layout for the promoted apps arr
    ...
    func configureDataSource() {
        ...
        // provides a cell that is going to return an indexpath for a cell
